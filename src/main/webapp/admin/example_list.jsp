...
<div class="container">
	...
	<div>
		<form class="form-inline" method="post" action="">
			<a class="btn btn-warning" href="exampleAdd.action">添加案例</a>
		</form>
	</div>
	...
	<s:iterator value="exampleList">
         <tr>
			...
			<td>
				<p><a class="btn btn-success" href="exampleEdit.action?example.id=<s:property value="id"/>">修改</a></p>
				<p><a class="btn btn-danger" href="exampleDelete.action?example.id=<s:property value="id"/>">删除</a></p>
			</td>
       	</tr>
     </s:iterator>
